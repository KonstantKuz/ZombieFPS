...
namespace RootMotion.Dynamics {
	...
	public partial class PuppetMaster: MonoBehaviour {
        ...
        public void RemoveMuscleRecursive(ConfigurableJoint joint, bool attachTarget, bool blockTargetAnimation = false, MuscleRemoveMode removeMode = MuscleRemoveMode.Sever, bool canSetNullParent = true)
        {
            if (!CheckIfInitiated()) return;
