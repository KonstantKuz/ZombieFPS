...
namespace DigitalRubyShared
{
    ...
    public class ScaleGestureRecognizer : DigitalRubyShared.GestureRecognizer
    {
        ...
        private void ProcessTouches()
        {
            ...
            {
                distance = distanceX = distanceY = previousDistance = previousDistanceX = previousDistanceY = 0.0f;
                return;
            }
        ...
        /// </summary>
        public float ScaleDistance { get { return distance; } }

        /// <summary>
        /// Current scale distance x value
        /// </summary>
        public float ScaleDistanceX { get { return distanceX; } }

        /// <summary>
        /// Current scale distance y value
        /// </summary>
        public float ScaleDistanceY { get { return distanceY; } }

        /// <summary>
        /// Previous scale distance
        /// </summary>
        public float PreviousScaleDistance { get { return previousDistance; } }

        /// <summary>
        /// Previous scale distance x value
        /// </summary>
        public float PreviousScaleDistanceX { get { return previousDistanceX; } }

        /// <summary>
        /// Previous scale distance y value
        /// </summary>
        public float PreviousScaleDistanceY { get { return previousDistanceY; } }

        /// <summary>
        /// Scale distance delta
        /// </summary>
        public float ScaleDistanceDelta { get { return distance - previousDistance; } }

        /// <summary>
        /// Scale distance delta x
        /// </summary>
        public float ScaleDistanceDeltaX { get { return distanceX - previousDistanceX; } }

        /// <summary>
        /// Scale distance delta y
        /// </summary>
        public float ScaleDistanceDeltaY { get { return distanceY - previousDistanceY; } }
